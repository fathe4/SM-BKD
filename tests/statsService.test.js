...
const statsService_1 = require("../src/services/statsService");
...
describe('StatsService', () => {
    ...
    describe('getQuickStats', () => {
        it('should return quick stats for a user', async () => {
            ...
            const result = await statsService_1.StatsService.getQuickStats(userId);
        ...
        it('should handle errors gracefully', async () => {
            ...
            await expect(statsService_1.StatsService.getQuickStats(userId)).rejects.toThrow('Failed to fetch quick statistics');
        });
    });
    describe('getUserStats', () => {
        it('should return comprehensive stats for a user', async () => {
            ...
            const result = await statsService_1.StatsService.getUserStats(userId);
            expect(result).toEqual({
                userId,
                totalPosts: 2,
                totalBoostedPosts: 1,
...
//# sourceMappingURL=statsService.test.js.map