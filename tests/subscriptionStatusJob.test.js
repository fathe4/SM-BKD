...
const subscriptionStatusJob_1 = require("../src/jobs/subscriptionStatusJob");
...
describe('SubscriptionStatusJob', () => {
    const mockSupabaseAdmin = supabase_1.supabaseAdmin;
    ...
    it('should setup the job correctly', () => {
        (0, subscriptionStatusJob_1.setupSubscriptionStatusJob)();
...
//# sourceMappingURL=subscriptionStatusJob.test.js.map